...
exports.export_to_spreadsheet = export_to_spreadsheet;
...
function export_to_spreadsheet(finalData, sheetName) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield jwtClient.authorize(); //jwtAuthPromise = jwtClient.authorize()
        yield googleapis_1.google.sheets("v4").spreadsheets.values.append({
